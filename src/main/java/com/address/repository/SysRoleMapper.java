...
public interface SysRoleMapper {
    ...
    @Select("SELECT role_id, role_code, role_name, status, create_time FROM SYS_ROLE WHERE role_id = #{roleId}")
    @Results({
    ...
    @Select("SELECT role_id, role_code, role_name, status, create_time FROM SYS_ROLE WHERE role_code = #{roleCode}")
    @Results({
        @Result(property = "roleId", column = "role_id"),
        @Result(property = "roleCode", column = "role_code"),
        @Result(property = "roleName", column = "role_name"),
    ...
    @Select("SELECT role_id, role_code, role_name, status, create_time FROM SYS_ROLE")
    @Results({
        @Result(property = "roleId", column = "role_id"),
        @Result(property = "roleCode", column = "role_code"),
        @Result(property = "roleName", column = "role_name"),
